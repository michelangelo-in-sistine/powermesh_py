...
SEC_LSDU					= 16
SEC_NPDU					= SEC_LSDU
SEC_PSR_NSDU				= SEC_NPDU + 3
SEC_DST_NSDU                = SEC_NPDU + 6
#SEC_MPDU					= SEC_NSDU
#SEC_MSDU					= SEC_MPDU + 1
#SEC_APDU					= SEC_MSDU
...
SEC_LPDU_PSR_NSDU			= SEC_PSR_NSDU - SEC_LPDU
...
SEC_LPDU_PSR_MPDU			= SEC_LPDU_PSR_NSDU
SEC_NSDU_MSDU               = LEN_MPCI
SEC_NSDU_APDU               = LEN_MPCI
...
SEC_ACP_DOMH                = 0x02
SEC_ACP_DOML                = 0x03
SEC_ACP_DB_BODY             = 0x04

SEC_ACP_VC_VIDH             = 0x04
SEC_ACP_VC_VIDL             = 0x05
SEC_ACP_VC_BODY             = 0x06

SEC_ACP_MC_STRH             = 0x04
SEC_ACP_MC_STRL             = 0x05
SEC_ACP_MC_ENDH             = 0x06
SEC_ACP_MC_ENDL             = 0x07
SEC_ACP_MC_SELH             = 0x08
SEC_ACP_MC_SELL             = 0x09
SEC_ACP_MC_BODY             = 0x0A

SEC_ACP_GB_GIDH             = 0x04
SEC_ACP_GB_GIDL             = 0x05
SEC_ACP_GB_BODY             = 0x06
